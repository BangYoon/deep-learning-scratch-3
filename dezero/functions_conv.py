...
from dezero.functions import linear, broadcast_to, linear_simple
...
def conv2d_simple(x, W, b=None, stride=1, pad=0):
    ...
    Weight = Weight.reshape(OC, -1).transpose() # reshape -> (OC, C*KH*KW)
    t = linear_simple(col, Weight, b) # 편향까지 포함한 선형 변환 
